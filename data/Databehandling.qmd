...
Ser at EnAmb har 13884 observasjoner (mot 3067 i ENOVA_Vestland). Noe av veksten i antall obs. kan skyldes multiple salg, noe kan skyldes at objektene ikke er entydig definert vha. Bygningsnummer, knr, gnr, bnr. Typisk problem med boligblokker, borettslag og seksjonerte eiendommer. Dere har postaddresse både i ENOVA_Vestland og Ambita. I Ambita er postadressen splittet i varaiablene EiendomAdressegatenavn, EiendomAdressehusnr og EiendomAdressebokstav. I ENOVA_Vestland er dette kombinert i variabelen GateAdresse. Dere kan prøve å splitte også denne opp i variablene EiendomAdressegatenavn, EiendomAdressehusnr og EiendomAdressebokstav. Da vil dere få anledning til også å matche på adresse. Dere må nok bruke regexp (se r4ds.had.co.nz cap. 14 særlig 14.3) og også andre funksjoner fra str\_ for å få alt på samme form (bruk av hhv. stor og liten bokstav). Dette er en kjekk liten utfordring ;-)

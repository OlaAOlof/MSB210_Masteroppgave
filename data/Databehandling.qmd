...
ev_10_18 <- paste("Energikarakterer_", 2010:2018, sep = "")
ev_19_22 <- paste("Energikarakterer_", 2019:2022, sep = "")
...
**Det største problemet blir å kombinere info. fra EV og Enova. Her har dere for lite info. i EV**
...
Ambita <- read_excel("Ambita_Delvis.xlsx")
```
...
```{r}
write.csv(Analyse, "data/Datasett_Analyse.csv")
```

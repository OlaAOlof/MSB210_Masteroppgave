...
borettslag_data <- blokkleilighet_data[!is.na(blokkleilighet_data$Andelsnr), ]
```
...
bergen$andelsnr_dummy <- ifelse(!is.na(bergen$Andelsnr), 1, 0)

# Kjører ny modell med dummy for andelsleilighet med fellesgjeld (1) eller ikke (0)
total_modell <- lm(P ~ EL_Kr_O + Alder + O_Karak + BLEnrgW + MatValg + andelsnr_dummy, data = bergen)

...
```{r Modell Blokk_Forslag_Eksl_Bergen}
options(scipen = 999)
modBlokkForslag_Eksl_Bergen <- "I(log(pm2)) ~ 
  EL.Kar.Original + 
  I(log(Alder+1)) + 
  O.Karak + 
  log(BLEnergikWh) + 
  ...
  Kommune + 
  I(log(dist_cbd_km))"
OLSBlokkForslag_Eksl_Bergen <- lm(modBlokkForslag_Eksl_Bergen, data = Blokker_Eksl_Bergen_sf)
summary(OLSBlokkForslag_Eksl_Bergen)
AIC(OLSBlokkForslag_Eksl_Bergen)
BIC(OLSBlokkForslag_Eksl_Bergen)
```

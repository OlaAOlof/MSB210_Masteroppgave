...
selveier_data \<- bergen\[bergen$BolType != "Blokkleilighet", ] borettslag_data <- bergen[bergen$BolType == "Blokkleilighet", \]

## Tar alle boligblokker

blokkleilighet_data \<- bergen\[bergen\$BolType == "Blokkleilighet", \]

## Del datasettet i to grupper basert på eierform (selveier og borettslag)

selveier_data \<- blokkleilighet_data\[!is.na(blokkleilighet_data$Snr), ] borettslag_data <- blokkleilighet_data[blokkleilighet_data$Snr == 0, \]
...
# Del datasettet i to grupper basert på eierform (selveier og borettslag)
#selveier_data <- blokkleilighet_data[!is.na(blokkleilighet_data$Snr), ]
#borettslag_data <- blokkleilighet_data[is.na(blokkleilighet_data$Snr), ]
```
...
Selveier <- lm(I(log(pm2)) ~ EL.Kar.Original + Alder + O.Karak + BLEnergikWh + MatValg, data = Selveier)
FG <- lm(I(log(pm2)) ~ EL.Kar.Original + Alder + O.Karak + BLEnergikWh + MatValg, data = FG)
...
Analyse_sf$FG_dum <- ifelse(Analyse_sf$Snr == 0, 1, 0)

# Kjører ny modell med dummy for andelsleilighet med fellesgjeld (1) eller ikke (0)
total_modell <- lm(I(log(pm2)) ~ EL.Kar.Original + Alder + O.Karak + BLEnergikWh + MatValg + FG_dum, data = Analyse_sf)
```
...
```{r Modell Bolig_1, eval=FALSE}}
options(scipen = 999)

modBolig1 <- "I(log(pm2)) ~ EL.Kar.Original"
...
```{r  Modell Bolig_2, eval=FALSE}}
options(scipen = 999)

modBolig2 <- "I(log(pm2)) ~ EL.Kar.Original + 
  I(log(Alder+1))"
...
```{r Modell Bolig_3, eval=FALSE}}
options(scipen = 999)

modBolig3 <- "I(log(pm2)) ~ EL.Kar.Original + 
  I(log(Alder+1)) + 
  O.Karak"
...
```{r Modell Bolig_4, eval=FALSE}}
options(scipen = 999)

modBolig4 <- "I(log(pm2)) ~ EL.Kar.Original + 
  I(log(Alder+1)) + 
  O.Karak + 
  log(BLEnergikWh)"
...
```{r Modell Bolig_5, eval=FALSE}}
options(scipen = 999)

modBolig5 <- "I(log(pm2)) ~ EL.Kar.Original + 
  I(log(Alder+1)) + 
  O.Karak + 
  log(BLEnergikWh) + 
  MatValg"
...
```{r Modell Bolig_6, eval=FALSE}}
options(scipen = 999)

modBolig6 <- "I(log(pm2)) ~ EL.Kar.Original + 
  I(log(Alder+1)) + 
  O.Karak + 
  log(BLEnergikWh) + 
  MatValg + 
...
```{r Modell Bolig_7, eval=FALSE}}
options(scipen = 999)

modBolig7 <- "I(log(pm2)) ~ EL.Kar.Original + 
  I(log(Alder+1)) +
  O.Karak + 
  log(BLEnergikWh) + 
  MatValg + 
...
```{r Modell Bolig_8, eval=FALSE}}
options(scipen = 999)

modBolig8 <- "I(log(pm2)) ~ EL.Kar.Original + 
  I(log(Alder+1)) + 
  O.Karak + 
  log(BLEnergikWh) + 
  MatValg + 
...
```{r Modell Bolig_9, eval=FALSE}}
options(scipen = 999)

modBolig9 <- "I(log(pm2)) ~ EL.Kar.Original + 
  I(log(Alder+1)) + 
  O.Karak + 
  log(BLEnergikWh) + 
  MatValg + 
...
```{r Modell Bolig_10, eval=FALSE}}
options(scipen = 999)

modBolig10 <- "I(log(pm2)) ~ EL.Kar.Original + 
  I(log(Alder+1)) + 
  O.Karak + 
  log(BLEnergikWh) + 
  MatValg + 
...
```{r Modell Bolig_11, eval=FALSE}}
options(scipen = 999)

modBolig11 <- "I(log(pm2)) ~ EL.Kar.Original + 
  I(log(Alder+1)) + 
  O.Karak + 
  log(BLEnergikWh) + 
  MatValg + 
...
```{r Modell Bolig_12, eval=FALSE}}
options(scipen = 999)

modBolig12 <- "I(log(pm2)) ~ EL.Kar.Original + 
  I(log(Alder+1)) + 
  O.Karak + 
  log(BLEnergikWh) + 
  MatValg + 
...
```{r Modell Bolig_13, eval=FALSE}}
options(scipen = 999)

modBolig13 <- "I(log(pm2)) ~ EL.Kar.Original + 
  I(log(Alder+1)) + 
  O.Karak + 
  log(BLEnergikWh) + 
  MatValg + 
...
```{r Modell Bolig_14, eval=FALSE}}
options(scipen = 999)

modBolig14 <- "I(log(pm2)) ~ EL.Kar.Original + 
  I(log(Alder+1)) + 
  O.Karak + 
  log(BLEnergikWh) + 
  MatValg + 
...
```{r Modell Bolig_15, eval=FALSE}}
options(scipen = 999)

modBolig15 <- "I(log(pm2)) ~ EL.Kar.Original + 
  I(log(Alder+1)) + 
  O.Karak + 
  log(BLEnergikWh) + 
  MatValg + 
...
```{r Modell Bolig_16, eval=FALSE}}
options(scipen = 999)

modBolig16 <- "I(log(pm2)) ~ EL.Kar.Original + 
  I(log(Alder+1)) + 
  O.Karak + 
  log(BLEnergikWh) + 
  MatValg + 
...
```{r Modell Bolig_17, eval=FALSE}}
options(scipen = 999)
modBolig17 <- "I(log(pm2)) ~ EL.Kar.Original + 
  I(log(Alder+1)) + 
  O.Karak + 
  log(BLEnergikWh) + 
  MatValg + 
  ...
  RegKulturByg + 
  I(log(AntallRom))"
OLSBolig17 <- lm(modBolig17, data = Bolig_sf)
summary(OLSBolig17)
AIC(OLSBolig17)
BIC(OLSBolig17)
```
...
```{r Modell Bolig_18, eval=FALSE}}
options(scipen = 999)
modBolig18 <- "I(log(pm2)) ~ EL.Kar.Original + 
  I(log(Alder+1)) + 
  O.Karak + 
  log(BLEnergikWh) + 
  MatValg + 
...
```{r Modell Bolig_19, eval=FALSE}}
options(scipen = 999)
modBolig19 <- "I(log(pm2)) ~ EL.Kar.Original + 
  I(log(Alder+1)) + 
  O.Karak + 
  log(BLEnergikWh) + 
  MatValg + 
...
```{r Modell Bolig_20, eval=FALSE}}
options(scipen = 999)
modBolig20 <- "I(log(pm2)) ~ EL.Kar.Original + 
  I(log(Alder+1)) + 
  O.Karak + 
  log(BLEnergikWh) + 
  MatValg + 
...
```{r Modell Bolig_21, eval=FALSE}}
options(scipen = 999)
modBolig21 <- "I(log(pm2)) ~ EL.Kar.Original + 
  I(log(Alder+1)) + 
  O.Karak + 
  log(BLEnergikWh) + 
  MatValg + 
...
```{r Modell Bolig_22, eval=FALSE}}
options(scipen = 999)
modBolig22 <- "I(log(pm2)) ~ EL.Kar.Original + 
  I(log(Alder+1)) + 
  O.Karak + 
  log(BLEnergikWh) + 
  MatValg + 
...
```{r Modell Bolig_23, eval=FALSE}}
options(scipen = 999)
modBolig23 <- "I(log(pm2)) ~ EL.Kar.Original + 
  I(log(Alder+1)) + 
  O.Karak + 
  log(BLEnergikWh) + 
  MatValg + 
...
```{r Modell Bolig_24, eval=FALSE}}
options(scipen = 999)
modBolig24 <- "I(log(pm2)) ~ EL.Kar.Original + 
  I(log(Alder+1)) + 
  O.Karak + 
  log(BLEnergikWh) + 
  MatValg + 
...
```{r Modell Bolig_25, eval=FALSE}}
options(scipen = 999)
modBolig25 <- "I(log(pm2)) ~ EL.Kar.Original + 
  I(log(Alder+1)) + 
  O.Karak + 
  log(BLEnergikWh) + 
  MatValg + 
...
```{r Modell Bolig_26, eval=FALSE}}
options(scipen = 999)
modBolig26 <- "I(log(pm2)) ~ EL.Kar.Original + 
  I(log(Alder+1)) + 
  O.Karak + 
  log(BLEnergikWh) + 
  MatValg + 
...
```{r Modell Bolig_27, eval=FALSE}}
options(scipen = 999)
modBolig27 <- "I(log(pm2)) ~ EL.Kar.Original + 
  I(log(Alder+1)) + 
  O.Karak + 
  log(BLEnergikWh) + 
  MatValg + 
...
```{r Modell Bolig_Energi, eval=FALSE}}
options(scipen = 999)

modBoligEnergi <- "I(log(pm2)) ~ EL.Kar.Original + O.Karak + log(BLEnergikWh) + MatValg"
...
options(scipen = 999)
modBlokkForslag <- "I(log(pm2)) ~ EL.Kar.Original + 
  I(log(Alder+1)) + 
  O.Karak + 
  log(BLEnergikWh) + 
  MatValg + 
...
```{r Modell Bolig_Forslag, eval=FALSE}}
options(scipen = 999)
modBoligForslag <- "I(log(pm2)) ~ EL.Kar.Original + 
  I(log(Alder+1)) + 
  O.Karak + 
  log(BLEnergikWh) + 
  MatValg + 

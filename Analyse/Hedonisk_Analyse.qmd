...
Analyse_sf$EL.Kar.Original <- relevel(Analyse_sf$EL.Kar.Original, ref = "F") # Referanseverdi
```
...
```{r}
sem_model <- errorsarlm(Modell_SAR,
                      data = Analyse_sf,
                      listw = Analyse_W3,
                      tol.solve = 1e-10)
```

...
modBlokkEnergi <- "pm2 ~ EL.Kar.Original + O.Karak + BLEnergikWh + MatValg + Alder + Bruksareal.Enhet"
OLSBlokkEnergi <- lm(modBlokkEnergi, data = Blokker_sf)
summary(OLSBlokkEnergi)
AIC(OLSBlokkEnergi)
BIC(OLSBlokkEnergi)
...
```{r}
cat("Summary for SDM Model - Kommune, K3:\n")
summary(SDM_modell_Kommuner_K3)
```

```{r}
cat("Summary for SDM Model - Kommune, K10:\n")

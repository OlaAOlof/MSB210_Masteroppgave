...
### Vektmatrise, K = 3
Rppretter romlige vektmatriser for k-nærmeste naboer med k = 3
```{r}
...
### Vektmatrise, K = 5
Rppretter romlige vektmatriser for k-nærmeste naboer med k = 5
```{r}
...
### Vektmatrise, K = 10
Rppretter romlige vektmatriser for k-nærmeste naboer med k = 10
```{r}
...
Kev_model <- P ~ Alder + B.Ar + EL.Kar + Bruksareal.Enhet 

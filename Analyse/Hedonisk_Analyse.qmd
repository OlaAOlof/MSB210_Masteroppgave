...
Selveier <- log(pm2 ~ EL.Kar.Original + Alder + O.Karak + BLEnergikWh + MatValg, data = Selveier)
FG <- log(pm2 ~ EL.Kar.Original + Alder + O.Karak + BLEnergikWh + MatValg, data = FG)
...
total_modell <- log(pm2 ~ EL.Kar.Original + Alder + O.Karak + BLEnergikWh + MatValg + FG_dum, data = Analyse_sf)

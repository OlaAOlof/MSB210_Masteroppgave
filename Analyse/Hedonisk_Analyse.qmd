...
# VarImplot
```{r}
# Denne funksjonen utfører en regresjon med alle mulige delsett, der den tilpasser en OLS-modell for alle mulige kombinasjoner av prediktorer og returnerer en oppsummering av resultatene.
step <- ols_step_all_possible(OLSBlokk27)
```
```{r}
ols_plot_varimp(step)
```
